...
public class TestPerformance {
    ...
    public static void main(String[] args) {
        ...
        testDistance(TestUtils.createGridModel(5, 5, false, 1.0), v -> v);
        System.out.println("With GraphT:");
        testDistanceWithGraph(TestUtils.createGridModel(5, 5, false, 1.0),v -> v);
        ...
        System.out.println("Graph Model:");
        testDistance(TestUtils.createGridModel(10, 10, false, 1.0),v -> v);
        System.out.println("With GraphT:");
        testDistanceWithGraph(TestUtils.createGridModel(10, 10, false, 1.0),v -> v);
        System.out.println("Array:");
        testDistance(10,10);

        System.out.println("20");
        System.out.println("Graph Model:");
        testDistance(TestUtils.createGridModel(20, 20, false, 1.0),v -> v);
        System.out.println("With GraphT:");
        testDistanceWithGraph(TestUtils.createGridModel(20, 20, false, 1.0),v -> v);
        System.out.println("Array:");
        testDistance(20,20);
        ...
        System.out.println("Graph Model:");
        testDistance(TestUtils.createGridModel(30, 30, false, 1.0),v -> v);
        System.out.println("With GraphT:");
        testDistanceWithGraph(TestUtils.createGridModel(30, 30, false, 1.0),v -> v);
        System.out.println("Array:");
        testDistance(30,30);

        System.out.println("50");
        System.out.println("Graph Model:");
        testDistance(TestUtils.createGridModel(50, 50, false, 1.0),v -> v);
        System.out.println("With GraphT:");
        testDistanceWithGraph(TestUtils.createGridModel(50, 50, false, 1.0),v -> v);
        System.out.println("Array:");
        testDistance(50,50);

        System.out.println("100");
        System.out.println("Graph Model:");
        testDistance(TestUtils.createGridModel(100, 100, false, 1.0),v -> v);
        System.out.println("With GraphT:");
        testDistanceWithGraph(TestUtils.createGridModel(100, 100, false, 1.0),v -> v);
        System.out.println("Array:");
...
//        testDistance(1000,1000);
        System.out.println("======");
//        testDistance(TestUtils.createGridModel(100, 100, false, 1.0),v -> v);
        //       testDistance(TestUtils.createGridModel(1000, 1000, false, 1.0),v -> v);
//
//
    }

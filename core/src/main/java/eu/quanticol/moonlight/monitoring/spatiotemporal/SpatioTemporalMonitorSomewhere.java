 ...
 *
 */
public class SpatioTemporalMonitorSomewhere<E,S,T> implements SpatioTemporalMonitor<E, S, T> {
	...
	public SpatioTemporalMonitorSomewhere(SpatioTemporalMonitor<E, S, T> m,
    ...
    private SpatioTemporalSignal<T> computeSomewhereDynamic(

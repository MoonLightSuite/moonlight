 ...
 *
 */
public class SpatioTemporalMonitorEverywhere<E,S,T> implements SpatioTemporalMonitor<E, S, T> {
	...
	public SpatioTemporalMonitorEverywhere(SpatioTemporalMonitor<E, S, T> m,
    ...
    private SpatioTemporalSignal<T> computeEverywhereDynamic(
            LocationService<E> l, SpatioTemporalSignal<T> s) {

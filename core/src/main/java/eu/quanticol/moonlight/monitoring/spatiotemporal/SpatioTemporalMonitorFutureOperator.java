 ...
 *
 */
public class SpatioTemporalMonitorFutureOperator<E,S,T> implements SpatioTemporalMonitor<E, S, T> {
	...
	public SpatioTemporalMonitorFutureOperator(SpatioTemporalMonitor<E, S, T> m,
			Interval interval,
			BiFunction<T, T, T> op,
			T init) {
		this.m = m;

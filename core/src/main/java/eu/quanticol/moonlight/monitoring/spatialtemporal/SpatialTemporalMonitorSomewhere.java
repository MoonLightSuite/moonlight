 ...
 *
 */
public class SpatialTemporalMonitorSomewhere<E,S,T> implements SpatialTemporalMonitor<E, S, T> {
	...
	public SpatialTemporalMonitorSomewhere(SpatialTemporalMonitor<E, S, T> m,

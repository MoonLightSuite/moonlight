...
booleanMonitorResult = monitor.temporalMonitor("BooleanMonitorScript",time,values);

%evalaute the QuantitativeMonitorScript defined in multipleMonitors.mls
%Formula: globally [0, 0.2]  #[ x > y ]#
quantiativeMonitorResult = monitor.temporalMonitor("QuantitativeMonitorScript",time,values);

...
//        showActivityCompletedMessage();
    ...
    private void doSpatialTemporalMonitoring(MoonLightSpatialTemporalScript spatialTemporal) throws IOException {
        ...
        LocationService<MoonLightRecord> space = loadLocationService(signal.size(),component.getEdgeHandler(),parameters.getOrDefault(SPACE, "space.csv"));
        showStartActivityMessage(MONITORING_STARTED);
    ...
    private LocationService<MoonLightRecord> loadLocationService(int size, RecordHandler edgeHandler, String fileName) throws IOException {
